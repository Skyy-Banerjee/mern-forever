...
const Cart = () => {
  ...
  useEffect(() => {
    ...
    setCartData(tempData); // Update the state with the computed cart data
  }, [cartItems]);
        ...
        {cartData.map((item, idx) => {
          ...
          if (!productData) {
            return (
              <div
                key={idx}
                className="py-4 border-t border-b text-red-500 grid grid-cols-1">
                <p>Product not found in the catalog.</p>
              </div> 
            );
          }
          ...
          return (
            <div
              ...
              <input
                ...
                onWheel={(e) => e.target.blur()} // Prevent scroll while focused
